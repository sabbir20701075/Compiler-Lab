...
#line 24 "Bcalc.y"
    {
             printf("= %d (0x%x) (0o%o) ", (yyvsp[(2) - (3)]), (yyvsp[(2) - (3)]), (yyvsp[(2) - (3)]));  // Decimal, Hexadecimal, Octal
             print_binary((yyvsp[(2) - (3)]));  // Print in Binary
         ;}
    break;
